...
export default function PrivacyPolicyPage() {
  return (
    <main style={{ maxWidth: 900, margin: "0 auto", padding: "28px 16px" }}>
      <h1 style={{ fontSize: 34, margin: "0 0 10px" }}>Privacy Policy</h1>
      ...
      <p>
        ...
        {" "}https://miamiairductsolution.com.
      </p>

      <h2>Comments</h2>
      <p>
        <strong>Suggested text: </strong>When visitors leave comments on the site
        we collect the data shown in the comments form, and also the visitor’s
      ...
      <h2>Cookies</h2>
      <p>
        <strong>Suggested text: </strong>If you leave a comment on our site you
        may opt-in to saving your name, email address and website in cookies.
      ...
      <p>
        <strong>Suggested text: </strong>If you leave a comment, the comment and
        its metadata are retained indefinitely. This is so we can recognize and
      ...
      <p>
        <strong>Suggested text: </strong>If you provide your phone number through
        our website, you may consent to receive SMS text messages from Miami Air
        Duct Solution. These messages may include appointment confirmations,
        service updates, estimates, reminders, and promotional messages.
      </p>
      <p>
      ...
      <h2>SMS Terms</h2>
      <p>
        <strong>Suggested text: </strong>By providing your phone number and opting
        in, you agree to receive SMS communications from Miami Air Duct Solution.
      </p>
      <p>
        These messages may include transactional and promotional content related
        to our services. Message frequency may vary. Message and data rates may
        apply.
      </p>
      <p>
